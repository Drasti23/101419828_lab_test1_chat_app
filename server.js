...
const MONGO_URI = "mongodb+srv://drastiparikh23:Dp%4023063@cluster0.a5txz.mongodb.net/chatApp?retryWrites=true&w=majority&appName=Cluster0";
...
io.on('connection', (socket) => {
    ...
    socket.on('leaveRoom', (room) => {
        ...
        io.to(room).emit('message', { from_user: 'System', message: `${authRoutes.username} left the room` });
    });
